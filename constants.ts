...
export const MOCK_CONTRACTS: Contract[] = [
    { id: 'con-001', employeeId: 'emp-001', companyId: 'com-001', startDate: '2021-02-15', isIndefinite: true, status: 'Activo' },
    { id: 'con-002', employeeId: 'emp-002', companyId: 'com-001', startDate: '2022-08-01', endDate: '2024-07-31', isIndefinite: false, status: 'Activo' },
    { id: 'con-003', employeeId: 'emp-003', companyId: 'com-002', startDate: '2020-05-20', endDate: '2025-05-19', isIndefinite: false, status: 'Activo' },
    { id: 'con-004', employeeId: 'emp-004', companyId: 'com-002', startDate: '2022-11-10', endDate: '2024-11-09', isIndefinite: false, status: 'Activo' },
    { id: 'con-005', employeeId: 'emp-005', companyId: 'com-002', startDate: '2019-07-01', endDate: '2026-06-30', isIndefinite: false, status: 'Activo' },
    { id: 'con-006', employeeId: 'emp-006', companyId: 'com-003', startDate: '2023-01-30', endDate: '2025-01-29', isIndefinite: false, status: 'Activo' },
    { id: 'con-007', employeeId: 'emp-007', companyId: 'com-003', startDate: '2021-09-01', endDate: '2023-08-31', isIndefinite: false, status: 'Finalizado' },
];
...
const getFutureDate = (days: number) => {
    const date = new Date('2025-09-01T00:00:00'); // Set a fixed date for consistency
...
// Mocks for the new Professional Dashboard
export const MOCK_UPCOMING_PAYROLLS: UpcomingPayroll[] = [
  { clientId: 'com-003', clientName: 'Constructora del Este', payrollType: '2da Quincena', dueDate: getFutureDate(8), status: PayrollStatus.PENDING },
  { clientId: 'com-001', clientName: 'CaribeTech SRL', payrollType: 'Mensual', dueDate: getFutureDate(10), status: PayrollStatus.REVIEW },
  { clientId: 'com-002', clientName: 'Quisqueya Soluciones', payrollType: '2da Quincena', dueDate: getFutureDate(12), status: PayrollStatus.PENDING },
  { clientId: 'com-001', clientName: 'CaribeTech SRL', payrollType: 'Semanal', dueDate: getFutureDate(-2), status: PayrollStatus.APPROVED },
];

export const MOCK_PROFESSIONAL_ALERTS: ProfessionalAlert[] = [
  { id: 'al-1', type: AlertType.ALERT, text: 'El empleado Juan Pérez (CaribeTech) cumple su período de prueba mañana.', clientId: 'com-001' },
  { id: 'al-2', type: AlertType.REMINDER, text: 'La fecha límite para presentar el IR-3 de Quisqueya Soluciones es el 10 de septiembre.', clientId: 'com-002' },
  { id: 'al-3', type: AlertType.ERROR, text: 'La sincronización con QuickBooks para Constructora del Este falló.', clientId: 'com-003' },
  { id: 'al-4', type: AlertType.INFO, text: 'Se ha añadido un nuevo empleado en CaribeTech pendiente de completar su información bancaria.', clientId: 'com-001' },
];

export const MOCK_PROFESSIONAL_ACTIVITY: ProfessionalActivity[] = [
  { id: 'ac-1', timestamp: 'Hace 15 min', user: 'Laura G.', action: 'Aprobó la nómina de CaribeTech SRL.' },
  { id: 'ac-2', timestamp: 'Hace 1 hora', user: 'Pedro M.', action: 'Añadió a "Nueva Empresa SRL" como cliente.' },
  { id: 'ac-3', timestamp: 'Hace 3 horas', user: 'Sistema', action: 'Se generó el reporte de TSS para Quisqueya Soluciones.' },
  { id: 'ac-4', timestamp: 'Ayer', user: 'Laura G.', action: 'Actualizó el salario de 2 empleados en Constructora del Este.' },
];

export const MOCK_TEAM_MEMBERS: TeamMember[] = [
  { id: 'tm-001', name: 'Laura Gómez', email: 'laura.gomez@micuenta.do', avatarUrl: 'https://picsum.photos/id/1011/200/200', role: 'Admin', status: 'Activo', assignedCompanies: ['com-001', 'com-003'] },
  { id: 'tm-002', name: 'Pedro Martínez', email: 'pedro.martinez@micuenta.do', avatarUrl: 'https://picsum.photos/id/1012/200/200', role: 'Contador', status: 'Activo', assignedCompanies: ['com-002'] },
  { id: 'tm-003', name: 'Ana Rosario', email: 'ana.rosario@micuenta.do', avatarUrl: 'https://picsum.photos/id/1013/200/200', role: 'Contador', status: 'Invitación Pendiente' },
];
...
export const MOCK_BILLING_INFO: BillingInfo = {
    ...
    invoices: [
        { id: 'inv-001', date: '2025-09-01', amount: 500, status: 'Pagada' },
        { id: 'inv-002', date: '2025-08-01', amount: 500, status: 'Pagada' },
        { id: 'inv-003', date: '2025-07-01', amount: 500, status: 'Pagada' },
    ]
};
...
export const MOCK_AUDIT_LOGS: AuditLogEvent[] = [
    { id: 'aud-001', timestamp: new Date().toISOString(), userId: 'tm-001', actionType: 'LOGIN', description: 'Laura Gómez inició sesión.', ipAddress: '192.168.1.1' },
    { id: 'aud-002', timestamp: new Date(Date.now() - 2 * 60 * 1000).toISOString(), userId: 'tm-001', actionType: 'GENERATE_REPORT', description: 'Laura Gómez generó el reporte de TSS para CaribeTech SRL.', ipAddress: '192.168.1.1' },
    { id: 'aud-003', timestamp: new Date(Date.now() - 5 * 60 * 1000).toISOString(), userId: 'tm-002', actionType: 'UPDATE', description: 'Pedro Martínez actualizó el salario del empleado John Doe a $155,000.', ipAddress: '200.111.55.23' },
    { id: 'aud-004', timestamp: yesterday.toISOString(), userId: 'tm-002', actionType: 'PROCESS_PAYROLL', description: 'Pedro Martínez procesó la nómina de Quisqueya Soluciones.', ipAddress: '200.111.55.23' },
