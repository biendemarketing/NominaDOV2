      ...
      <header className="bg-white/80 backdrop-blur-lg fixed top-0 left-0 right-0 z-50 border-b border-gray-200/80">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="md:hidden">
            <button onClick={() => setIsMobileMenuOpen(true)} className="text-primary">
      ...
      <div className={`fixed inset-0 bg-white z-50 transform ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out md:hidden`}>
          ...
          <nav className="flex flex-col p-6 space-y-4">
              ...
              <div className="border-t pt-4 space-y-3">
                ...
                <button onClick={() => { setAuthView(AuthView.REGISTER); setIsMobileMenuOpen(false); }} className="w-full bg-secondary text-white font-bold py-2 px-5 rounded-lg hover:bg-secondary/90 transition-all duration-300 shadow-sm">
                    Registrarse
                </button>
              </div>
          </nav>
      ...
      <main>
        ...
        <section className="text-center pt-32 pb-16">
          <div className="container mx-auto px-6">
            <h1 className="text-4xl md:text-6xl font-bold text-primary">Nomina<span className="text-secondary">DO</span></h1>
            <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto text-gray-700">Tu nómina, sin complicaciones. La plataforma fintech que automatiza y simplifica la gestión de pagos en la República Dominicana.</p>
        ...
        <section id="features" className="py-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-primary">Todo lo que necesitas, en un solo lugar</h2>
        ...
        <section id="precios" className="py-20 bg-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-primary">Planes diseñados para tu empresa</h2>
            ...
            <div className="grid lg:grid-cols-3 gap-8 items-start">
              ...
              {/* Plan Profesional */}
              <div className="bg-primary text-white p-8 rounded-xl shadow-sm flex flex-col h-full lg:col-span-1 mt-8 lg:mt-0">
        ...
        <section id="challenge" className="my-16">
            <div className="container mx-auto px-6">
                <h2 className="text-3xl md:text-4xl font-bold text-primary text-center">El Desafío de la Nómina Dominicana</h2>
                <p className="mt-4 max-w-3xl mx-auto text-lg text-gray-700 text-center">Calcular la nómina es más que pagar salarios. Implica una compleja red de regulaciones, cálculos precisos y plazos estrictos que consumen tiempo y elevan el riesgo.</p>
        ...
        <section id="features-charts" className="my-16">
            <div className="container mx-auto px-6">
                <h2 className="text-3xl md:text-4xl font-bold text-primary text-center">Una Solución Integral y Automatizada</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg col-span-1 lg:col-span-2 flex flex-col justify-center">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg col-span-1 lg:col-span-3 flex flex-col justify-center">
        ...
        <section id="process" className="my-20">
            <div className="container mx-auto px-6">
                <h2 className="text-3xl md:text-4xl font-bold text-primary text-center">Procesa tu Nómina en 4 Simples Pasos</h2>
        ...
        {/* Advantage Section */}
         <section id="advantage" className="my-16">
            <div className="container mx-auto px-6">
                <div className="bg-primary text-white py-12 md:py-16 px-4 rounded-lg">
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
              <div className="text-center mb-12">
                  <h2 className="font-heading text-3xl md:text-4xl font-bold text-primary">Amado por empresas en toda la isla</h2>
              </div>
        ...
        <section id="faq" className="py-20 bg-white">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <h2 className="font-heading text-3xl md:text-4xl font-bold text-primary">Preguntas Frecuentes</h2>
        ...
        <section className="pb-20">
          <div className="container mx-auto px-6">
            <div className="relative bg-primary text-white p-8 md:p-12 rounded-2xl shadow-xl text-center overflow-hidden">
                ...
                <div className="relative z-10">
                    <h2 className="font-heading text-3xl md:text-4xl font-bold">¿Listo para simplificar tu nómina?</h2>
