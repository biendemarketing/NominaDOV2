...
// FIX: Import CartesianGrid from recharts to fix 'Cannot find name' error.
...
const FirmAnalytics: React.FC<FirmAnalyticsProps> = ({ companies, employees, contracts }) => {
  ...
  const payrollCostByCompany = useMemo(() => {
    return companies.map(company => {
  ...
  return (
    <div className="p-8">
      <h1 className="font-heading text-3xl font-bold text-primary">Analítica de la Firma</h1>
