...
const ProfessionalDashboard: React.FC<ProfessionalDashboardProps> = ({ companies, employees, upcomingPayrolls, professionalAlerts, professionalActivity, onSelectCompany }) => {
    ...
    return (
        <div className="p-8">
            <h1 className="font-heading text-3xl font-bold text-primary">Dashboard Profesional</h1>
            <p className="text-gray-500 mt-1">Centro de comando para la gestión de todas tus empresas.</p>

            {/* KPIs */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                <KpiCard icon={<Building2 className="w-6 h-6 text-secondary"/>} title="Empresas Activas" value={activeClients} />
                            ...
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="bg-light">
                                        <th className="py-3 px-4 text-sm font-semibold text-gray-500 uppercase">Empresa</th>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 mt-8">
                 ...
                 <Card>
                    <h2 className="font-heading text-xl font-bold text-primary mb-4">Distribución de Empleados</h2>
                ...
                <div className="xl:col-span-2">
                    <Card>
                        <h2 className="font-heading text-xl font-bold text-primary mb-4">Actividad Reciente</h2>
